...
class InvestmentService
{
    ...
    public function createOrRestore(array $data, $user_id = null)
    {
        ...
        return DB::transaction(function () use ($data, $user_id) {
            ...
            $investmentData = [
                ...
                'investment_amount_arabic' => $data['investment_amount_arabic'],
                ...
                'company_bank_account_number' => $data['company_bank_account_number'],
                'added_by' => $userId,
    ...
    public function update($id, array $data)
    {
        ...
        return DB::transaction(function () use ($id, $data) {
            ...
            $update_doc = $this->investmentContractDocumentService->updateInvestorDocument($investor->id, $companyId, $docInsertData);
            // dd($update_doc);

            $docInsertData['investment_contract_document_id'] = $update_doc->id;
            // Investment contract document updation
