   ...
   /* public function expectedSignatureCountFor($contract, string $signerRole): int
    ...
    private function sendViaEmail($contract, string $signerRole, string $signLink): void
    {
        ...
        $investorhtml = '<p>
                ...
                <p>يرجى التكرم بمراجعة اتفاقية الاستثمار المرفقة ، و التوقيع عليها
                    ' . document_name_ar($contract->agreementType->short_code) . ' من خلال الضغط على الرابط أدناه
                   .</p>
                <p>لاستخدام خيار "Add Signature"  يرجى التوقيع بما يتطابق مع التوقيع المعتمد في بطاقة الهوية الإماراتية او جواز السفر و من ثم اختيار "Submit" لارسال المستند ، و ذلك لاتمام التوقيع في جميع الأوراق بالأماكن المخصصة و من ثم الضغط على " Place Signature" </p>

                <p>في حال احتجتم اي مساعدة يرجى عدم التردد في التواصل معنا.</p>
