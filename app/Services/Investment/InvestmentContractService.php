...
class InvestmentContractService
{
    ...
    private function buildMudarabahPayload($invDocDetails, $documentDetail, $investorData, $investmentData): array
    {
        ...
        $investorParagraph = "trim('{$investorData->investor_prefix} {$investorData->investor_name}') resident of {$investorData->state}, {$investorData->countryOfResidence->nationality_name},
        having Investor ID no. {$investorData->id_number} {$guardian}";
        $investorParagraph_ar = "trim('{$investorData->investor_prefix_arabic} {$investorData->investor_name_arabic}') المقيم في {$investorData->state_arabic}, {$investorData->countryOfResidence->nationality_arabic_name} ،
    ...
    function clauseFive($investmentData)
    {
        ...
        if ($investmentData->investment_tenure != 12) {
            ...
            $fifthClause = '<tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"> <span>5.1 </span>تسري هذه الاتفاقية لمدة أولية قدرها أربعة عشرتظل هذه الاتفاقية سارية لمدة أولية قدرها ' . $tenure['months_ar'] . ' من تاريخ استلام الشركة لرأس مال الاستثمار. </p>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"><span>5.2 </span>يحق للمستثمر إنهاء هذه الاتفاقية من خلال توجيه إشعار خطي إلى الشركة قبل انتهاء المدة السارية وقتها، بما لايقل عن ثلاثين (30) يوماً. وعند إنهاء هذه الاتفاقية، تلتزم الشركة بإجراء التسوية النهائية للحسابات، وسداد رأس المال للمستثمر، بالإضافة إلى أي أرباح مستحقة له بموجب هذه الاتفاقية، وذلك خلال ' . $tenure['return_ar'] . '  من تاريخ سريان الإنهاء.</p>
                            </div>
                        </td>
                    </tr>
            ...
            $fifthClause = '<tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"> <span>5.1 </span>تسري هذه الاتفاقية لمدة أولية قدرها أربعة عشر (14)
                                    شهراً
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"> <span>5.2 </span>الإنهاء من جانب المستثمر - يجوز للمستثمر إنهاء هذه
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"> <span>5.3 </span> الإنهاء المبكر - يجوز للمستثمر طلب الإنهاء المبكر
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"> <span>5.4 </span>الإنهاء من جانب الشركة - يجوز للشركة إنهاء هذه
                                    الاتفاقية
        ...
        if ($investmentData->investment_tenure != 12) {
            $thirdClause = '<tr data-row style="background-color:#F2F2F2">
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"><span>3.1</span> تلتزم الشركة بحساب وصرف حصة المستثمر من الأرباح الفعلية المحققة بشكل شهري، أو بأي طريقة أو فترة ثانية يتفق عليها الطرفين ، وذلك مع مراعاة التسوية النهائية للحسابات </p>
                            </div>
                        </td>
                    </tr>';
        } else {
            $thirdClause = ' <tr data-row style="background-color:#F2F2F2">
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm"><span>3.1</span> تطبق فترة توظيف تصل إلى خمسة وأربعين (45) يوماً من
                    ...
                    <tr data-row>
                        ...
                        <td width="50%" style="border:1px solid #ccc;">
                            <div class="arabic">
                                <p class="marginClass text-sm">3.2 بعد توظيف رأس المال، تقوم الشركة باحتساب وصرف حصة المستثمر من
