                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bs-stepper">
                                    <form action="" id="contractForm">
                                        ...
                                        <div id="unit-step" class="content step-content" data-step="2" role="tabpanel"
                                            aria-labelledby="unit-step-trigger">
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                    <label for="exampleInputEmail1" class="asterisk">No. of
                                                        Units</label>
                                                    <input type="number" name="unit[no_of_units]" class="form-control"
                                                        id="no_of_units" placeholder="No. of Units"
                                                ...
                                                <div class="col-md-4 mt-4">
                                                    ...
                                                    <div class="icheck-success d-inline">
                                                        <input type="checkbox" id="watchmanrm" class="watchmanrmcheck"
                                                            value="1" name="unit[watchman_room]"
                                            ...
                                            <div class="normalBuilding">
                                                ...
                                                <div class="col-sm-6">
                                                    <button type="button" class=" btn btn-success" title="Add more"
                                                        id="add-more"> Add more <i class="fa fa-plus"></i></button>
                                                </div>
                                            </div> -->
                                        </div>
                                        <div class="fullBuilding">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="button" class=" btn btn-success" title="Add more"
                                                    id="add-more-fullBuilding"> Add more <i
                                                        class="fa fa-plus"></i></button>
                                            </div>
                                        </div> -->
                                </div>
                            ...
                            <div id="contract-step" class="content step-content" data-step="3" role="tabpanel"
                                aria-labelledby="contract-step-trigger">
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        <label for="exampleInputEmail1">Contract fee</label>
                                        <input type="number" class="form-control" name="detail[contract_fee]"
                                            id="contract_fee" placeholder="Contract fee"
                                            value="{{ old('contract_fee', $contract->contract_detail->contract_fee ?? '') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="exampleInputEmail1">Ejari</label>
                                        <input type="number" class="form-control" id="ejari" name="detail[ejari]"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group date" id="startdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input startdate"
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" class="form-control" id="duration_months"
                                            name="detail[duration_in_months]" placeholder="Duration in Months"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group date" id="enddate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input enddate"
                            ...
                            <div id="rental-step" class="content step-content" data-step="4" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="rent_per_annum"
                                            name="rentals[rent_per_annum_payable]" placeholder="Rent per annum"
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" class="form-control" id="commission_perc"
                                            name="rentals[commission_percentage]" placeholder="Commission %"
                                            value="{{ old('commission_percentage', $contract->contract_rentals->commission_percentage ?? '5') }}"
                                            required>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="exampleInputEmail1" class="asterisk">Commission</label>
                            ...
                            <div id="otc-step" class="content step-content" data-step="5" role="tabpanel"
                                aria-labelledby="otc-step-trigger">
                                <div class="form-group row">
                                    <div class="col-md-3">
                                        <label for="exampleInputEmail1">Cost of Development</label>
                                        <input type="number" class="form-control" id="cost_of_development"
                                            name="otc[cost_of_development]"
                            ...
                            <div id="payment-step" class="content step-content" data-step="6" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label for="exampleInputEmail1" class="asterisk">No. of
                                            Installments</label>
                                        {{-- <div class="input-group"> --}}
                                        <select class="form-control select2" name="payment[installment_id]"
                                            id="no_of_installments" required>
                                ...
                                <div class="payment_details">
                                    @if (isset($contract) && isset($contract->contract_payment_details))
                                        @include('admin.projects.contract.includes.edit_paymentdet', [
                            ...
                            <div id="rentalreceivable-step" class="content step-content" data-step="7" role="tabpanel"
                                ...
                                <div class="row invoice-info">
                                    <div class="col-sm-6 float-left">
                                        ...
                                        <address style="white-space: nowrap;">
                                            Total Contract Amt - <input class="total_contract_amount" readonly=""
                                                value="0.00" style="border:none;"><br>
                                            Commission - <input class="commssion_final" readonly="" value="0.00"
                                                style="border:none;"><br>
                                            Refundable Deposit - <input class="deposit_final" readonly=""
                                                value="0.00" style="border:none;"><br>
                                            Contract Fee - <input class="contract_final" readonly="" value="0.00"
                                                style="border:none;"><br>
                                            Total Payment to Vendor - <input class="payment_to_vendor"
                                                name="rentals[total_payment_to_vendor]" readonly="" value="0.00"
                                                style="border:none;"><br>
                                            Total OTC - <input class="total_otc_payable" name="rentals[total_otc]"
                                                readonly="" value="0.00" style="border:none;"><br>
                                            Final Cost - <input class="final_cost" readonly=""
                                                name="rentals[final_cost]" value="0.00" style="border:none;"><br>
                                            Initial Investment - <input class="initial_inv"
                                                name="rentals[initial_investment]" readonly="" value="0.00"
                                                style="border:none;"><br>
                                        </address>
                                    </div>
                                    ...
                                    <div class="col-sm-6 float-right">
                                        <span class="float-lg-right"><strong>Receivable
                                                Details</strong>
                                            <address style="white-space: nowrap;">
                                                Expected Rental PM - <input class="total_rent_receivable"
                                                    name="rentals[rent_receivable_per_month]" readonly=""
                                                    value="0.00" style="border:none;">
                                                <br>
                                                No. Of Months - <input class="no_of_months_final" readonly=""
                                                    value="0.00" style="border:none;">
                                                <br>
                                                Total Rental - <input class="total_rental"
                                                    name="rentals[rent_receivable_per_annum]" readonly=""
                                                    value="0.00" style="border:none;">
                                                <br>
                                            </address>
                                            <!-- <address>
                            ...
                            <div class="form-group row rentPerUnitFF">
                                @if (isset($contract) && isset($contract->contract_unit_details) && ($contract->contract_type_id ?? null) == '2')
                                    @include('admin.projects.contract.includes.edit_profitdet', [
                                        'contract_units_details' => $contract->contract_unit_details ?? [],
                                    ])
                                @endif
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-2 rentPartition">
                                    <label for="exampleInputEmail1" class="asterisk">Rent per
                                        Partition</label>
                                    {{-- @dd($contract); --}}
                                    <input type="number" class="form-control" name="unit_detail[rent_per_partition]"
                                        id="rent_per_part" placeholder="Rent per Partition"
                                ...
                                <div class="col-md-2 rentBedspace">
                                    <label for="exampleInputEmail1" class="asterisk">Rent per
                                        Bedspace</label>
                                    <input type="number" class="form-control" name="unit_detail[rent_per_bedspace]"
                                        id="rent_per_bs" placeholder="Rent per Bedspace"
                                ...
                                <div class="col-md-2 rentRoom">
                                    <label for="exampleInputEmail1" class="asterisk">Rent per
                                        Room</label>
                                    <input type="number" class="form-control" name="unit_detail[rent_per_room]"
                                        id="rent_per_room" placeholder="Rent per Room"
                                ...
                                <div class="col-md-2 rentFlat">
                                    <label for="exampleInputEmail1" class="asterisk">Rent per
                                        Flat</label>
                                    <input type="number" class="form-control" name="unit_detail[rent_per_flat]"
                                        id="rent_per_flat" placeholder="Rent per Flat"
                                ...
                                <div class="col-md-2">
                                    <label for="exampleInputEmail1" class="asterisk">Rent
                                        installments</label>
                                    <select class="form-control select2" name="rentals[receivable_installments]"
                                        id="rent_installments" required>
                                        <option value="">Select</option>
                                        @foreach ($installments as $installment)
                                            <option value="{{ $installment->id }}"
                                                data-interval="{{ $installment->interval }}"
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="roi" name="rentals[roi_perc]"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="expected_profit"
                                        name="rentals[expected_profit]" placeholder="Expected Profit" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label for="exampleInputEmail1">Profit%</label>
                                    <input type="text" class="form-control" id="profit"
                                        name="rentals[profit_percentage]" placeholder="Profit" readonly>
                                </div>
                                <!-- <div class="col-md-3">
                        ...
                        <div class="receivable_maindiv card col-md-12">
                            <div class="receivable_details p-4">
                                ...
                                @if (isset($contract) && isset($contract->contract_payment_receivables))
                                    @include('admin.projects.contract.includes.edit_paymentRec', [
                        ...
                        <br>
                        <button class="btn btn-info prevBtn" type="button">Previous</button>
                        <button type="submit" class="btn btn-info contractFormSubmit">Submit</button>
                    </div>
                </div>
                </form>
            </div>
    ...
    <script>
        function filterIndirectCompany() {
            ...
            if (com_id == 2) {
                ...
                $("#indirect_company_id").prepend('<option value="">Select Indirect Company</option>').trigger('change');
                fileterCompanies();
                // indirectCompanyId = 6;
            } else if (com_id == 4) {
                $(".indirect_div").removeClass("d-none");
                ...
                // Set indirect_company_id to 0
                $("#indirect_company_id").val("0").trigger('change');

                // Reset indirect_contract_id to 0
                $("#indirect_contract_id").html('<option value="">Select Indirect Project</option>').trigger('change');
                $("#indirect_contract_id").val("0");

                // Set indirect_status to 0
                $("#indirect_status").val(0);

                return;
            }

            // $("#indirect_company_id").val(indirectCompanyId).trigger('change');
            // $('#indirect_company_id').on('select2:opening select2:selecting keydown', function(e) {
            //     e.preventDefault();
            // });
