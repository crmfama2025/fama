            ...
            <div class="card">
                <div class="container-fluid p-3">
                    <div class="card-header  text-white">
                        ...
                        <a class="btn btn-info float-xl-right" href="{{ route('referrals.index') }}">Back</a>
                    </div>
                            ...
                            @else
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <span
                                            class="text-muted">{{ $investment->investedCompany->company_name ?? '-' }}</span>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <strong>Investment Amount:</strong>
                                        <span
                                            class="text-muted">{{ number_format($investment->investment_amount, 2) }}</span>
                                    </div>
                                    <div class="col-md-6 mb-2">
