...
@section('custom_js')
    ...
    <script>
        ...
        // Generate owner fields based on selected count
        ...
        //         container.innerHTML += `
    //             <div class="card card-outline card-info owner-card mb-3">
    //                 <div class="card-header">
    ...
    //                             <small class="text-muted font-weight-bold text-uppercase">Emirates ID</small>
    //                             <hr class="mt-1 mb-3">
    //                         </div>

    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Emirates ID Number</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Emirates ID Upload</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Emirates ID Issued Date</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Emirates ID Expiry Date</label>
    ...
    //                             <small class="text-muted font-weight-bold text-uppercase">Passport</small>
    //                             <hr class="mt-1 mb-3">
    //                         </div>

    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Passport Number</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Passport Upload</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Passport Issued Date</label>
    ...
    //                         <div class="col-md-6">
    //                             <div class="form-group">
    //                                 <label class="font-weight-bold small">Passport Expiry Date</label>
