            ...
            <div class="modal fade" id="modal-import">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="" id="paymentModeImportForm" method="POST" enctype="multipart/form-data">
                            @csrf
...
@section('custom_js')
    ...
    <script>
            ...
            let table = $('#paymentModeTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'payment_modes.payment_mode_short_code',
                    },
                    {
                        data: 'action',
                        name: 'action',
        ...
        $('#importBtn').on('click', function() {
            let formData = new FormData($('#paymentModeImportForm')[0]);
            $.ajax({
                url: "{{ route('import.paymentMode') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#modal-payment-mode').on('shown.bs.modal', function(event) {
            ...
            if (rowData) {
                $('#payment_mode_id').val(rowData.id);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            toastr.success(response.message);
                            $('#paymentModeTable').DataTable().ajax.reload();
                        }
                    });
