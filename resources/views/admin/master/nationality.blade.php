...
@section('custom_js')
    ...
    <script>
        $(function() {
            let table = $('#nationalityTable').DataTable({
                processing: true,
                serverSide: true,

                ajax: {
                    url: "{{ route('nationality.list') }}",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'nationalities.nationality_short_code',
                    },
                    {
                        data: 'action',
                        name: 'action',
        ...
        $('#importBtn').on('click', function() {
            let formData = new FormData($('#nationalityImportForm')[0]);

            $.ajax({
                url: "{{ route('import.nationality') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
