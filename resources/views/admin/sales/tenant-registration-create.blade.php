                                    ...
                                    <div class="row">
                                        ...
                                        <div id="b2bContactFields" style="display:none;" class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="asterisk">Contact Person Department</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="tradeLicenseIssuedDate"
                                                        ...
                                                        <input type="text" class="form-control datetimepicker-input"
                                                            ...
                                                            {{-- onchange="checkExpiry('trade_license_issued', 'tlExpiryWarn')" --}} data-target="#tradeLicenseIssuedDate"
    ...
    <script>
        ...
        function deleteAgreementUnit(btn) {
            ...
            Swal.fire({
                ...
                let url =
                    "{{ route('salesAgreement.unit.delete', ['agreement' => ':agreement', 'unitId' => ':unitId']) }}";

                url = url
                    .replace(':agreement', agreementId)
                    .replace(':unitId', unitDbId);
