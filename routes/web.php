...
Route::middleware(['auth', 'update.fcm'])->group(function () {
    ...
    // Route::get('/investors/{investorId}/investment-annexure', [InvestorController::class, 'downloadInvestmentAnnexure'])->name('investor.investment-annexure');
    ...
    // inventory report
    Route::get('report/inventory', [ContractReportController::class, 'inventoryReport'])->name('inventory-report.index');
    Route::get('report/inventory/data', [ContractReportController::class, 'inventoryReportData'])->name('inventory-report.data');
    Route::get('report/inventory/export', [ContractReportController::class, 'inventoryReportExport'])->name('inventory-report.export');

    // occupancy report
    Route::get('/report/occupancy', [ContractReportController::class, 'occupancyReport'])->name('occupancy-report');
    Route::get('/report/occupancy/data', [ContractReportController::class, 'occupancyReportData'])->name('occupancy-report.data');
    Route::get('/report/occupancy/export', [ContractReportController::class, 'occupancyReportExport'])->name('occupancy-report.export');
    //Receivable Report
    Route::get('report/receivable-report', [ReceivableReportController::class, 'index'])->name('receivable-report.index');
    Route::get('report/receivable-report-list', [ReceivableReportController::class, 'getReceivables'])->name('receivable-report.list');
    Route::get('report/receivable-report-export', [ReceivableReportController::class, 'exportReceivables'])->name('receivable-report.export');
